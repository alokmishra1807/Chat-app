...
const SignUp = () => {
  ...
  return (
    <div className='flex flex-col items-center justify-center mx-auto px-4 w-full sm:w-[26rem]'>
      <div className='w-full p-6 rounded-lg shadow-md bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0'>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <Link to="/login" className='text-sm text-black font-semibold hover:underline hover:font-bold mt-2 inline-block'>
